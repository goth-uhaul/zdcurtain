...
https://obsproject.com/kb/virtual-camera-guide"""
    ...
    def __read_loop(self):
        try:
            ...
            self._zdcurtain_ref.show_error_signal.emit(
                lambda: exception_traceback(
                    error,
                    "ZDCurtain encountered an unhandled exception while "
    ...
    def __init__(self, zdcurtain: "ZDCurtain"):
        ...
        self.capture_device = cv2.VideoCapture(zdcurtain.settings_dict["capture_device_id"])
